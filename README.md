...
| [E2. 이미지 변환기 비교](experiments/e2-transformer-ab/README.md) | 같은 이미지 묶음에서 libvips와 ImageMagick 중 어느 쪽이 적합한가? | 처리량, peak RSS, 파일 크기와 품질 | Corpus·native worker 구현 · AVIF thread 조건 확정 대기 |
