...
| [E2. 이미지 변환기 비교](experiments/e2-transformer-ab/README.md) | 같은 이미지 묶음에서 libvips와 ImageMagick 중 어느 쪽이 적합한가? | 처리량, peak RSS, 파일 크기와 품질 | [quality 수정본 전체 로컬 검증 통과](reports/e2-transformer-ab/local-20260910-c2/README.md) · 새 AWS 전체 측정 준비 |
