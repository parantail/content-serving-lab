...
| [E2. 이미지 변환기 비교](experiments/e2-transformer-ab/README.md) | 같은 이미지 묶음에서 libvips와 ImageMagick 중 어느 쪽이 적합한가? | 처리량, peak RSS, 파일 크기와 품질 | [5회 측정·품질 실행·AWS 제거 완료](reports/e2-transformer-ab/aws-20260910/README.md) · [quality 수정·64회 실제 값 확인](reports/e2-transformer-ab/quality-fix-20260910/README.md) · AWS 재로그인 대기 |
