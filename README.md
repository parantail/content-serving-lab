...
| [E2. 이미지 변환기 비교](experiments/e2-transformer-ab/README.md) | 같은 이미지 묶음에서 libvips와 ImageMagick 중 어느 쪽이 적합한가? | 처리량, peak RSS, 파일 크기와 품질 | [AWS 검증·calibration 및 제거 완료](reports/e2-transformer-ab/aws-calibration-20260910/README.md) · 본 측정 시간 gate 초과로 보류 |
