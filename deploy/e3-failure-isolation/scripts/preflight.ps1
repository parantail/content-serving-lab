...
param(
    ...
    [string]$NamePrefix = "content-serving-e3",
...
$tagged = Invoke-AwsJson -Profile $Profile -Region $Region -Arguments @(
    ...
    "--tag-filters", "Key=Project,Values=content-serving-lab", "Key=Experiment,Values=e3-failure-isolation"
)
...
if ($unrelated.Count -gt 0) {
    throw "Unrelated resources already use the E3 experiment tags. Remove or retag them before deploying."
}
