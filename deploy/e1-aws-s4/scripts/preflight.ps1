...
param(
    ...
    [string[]]$AvailabilityZones = @("ap-northeast-2a", "ap-northeast-2c"),
...
if ($null -eq $quota -or [double]$quota.Value -lt 8.0) {
    throw "Fargate On-Demand vCPU quota must be at least 8 in $Region."
}
