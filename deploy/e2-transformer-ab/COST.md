...
조회일: 2026-09-10. 서울 Linux/x86 Fargate, 한 번에 1 vCPU·2 GiB Task 하나, bootstrap부터 최대 5시간이다. **보수적 실행 견적 US$1.50**, 사전에 정한 상한 US$3 이내다. 자동 과금 차단 한도가 아니며 PC와 인증이 유효해야 로컬 watchdog가 동작한다.
