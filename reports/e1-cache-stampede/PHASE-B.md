...
따라서 S5는 아직 구현하지 않습니다. 먼저 ECS Task 2개와 4개, S3 저장소를 사용하는 조건에서 Task별 요청 수, 변환 횟수, CPU·메모리, 응답 시간, 오류와 비용을 측정합니다. 중복 변환의 실제 비용이 외부 조정 비용보다 크다고 확인될 때 S5를 검토합니다.
...
- 실제 ECS Task, S3 요청 시간·비용과 여러 프로세스 사이의 요청 합치기는 아직 측정하지 않았습니다.
