...
// resourceSampler mirrors the E1 cgroup sampler: cgroup v2 CPU usage, the
// process RSS and cgroup memory.current at a fixed gap.
...
func startResourceSampler(runID, trialID string, start time.Time, gap time.Duration) *resourceSampler {
